# -*- coding: utf-8 -*-
"""
Created on Mon Dec 31 18:29:04 2018
...
# Modified from Unet33d_pytorch.py (Dong Nie, 2017)
class UNet3D_GL(nn.Module):
    def __init__(self, in_channel=1, n_classes=4):
        """
        In the constructor we instantiate custom encoder/decoder modules and assign them as
        member variables.
        """
        self.in_channel = in_channel
        self.n_classes = n_classes
        super(UNet3D_GL, self).__init__()
